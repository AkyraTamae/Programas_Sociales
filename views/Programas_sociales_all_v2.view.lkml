view: programas_sociales_all_v2 {
  derived_table: {
    sql: Select
        D.Comercio,
        D.Fecha,
      ...
      Left Join
        ...
        Select --Puntos de venta
          ...
          E.NombreMedidas,
          E.rfc,
          MAX(E.Puntos_de_venta) As 'Puntos_de_Venta',
          CONCAT(E.Estado_Comercial, '_', E.NombreMedidas, '_', E.rfc) As 'KeyId'
        From
          (
          Select
            ROW_NUMBER() Over (Partition By CONCAT(D.Estado_Comercial, D.rfc, C.NombreMedidas) Order By D.rfc) 'Puntos_de_venta',
            C.NombreMedidas,
            D.Estado_Comercial,
            D.rfc
          From
        ...
        Group By
          ...
          E.Estado_Comercial,
          E.rfc
        )G On G.KeyId = CONCAT(E.Estado_Comercial, '_', D.NombreMedidas, '_', E.rfc) ;;
  }
