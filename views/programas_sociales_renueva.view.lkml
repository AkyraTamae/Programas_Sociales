...
view: programas_sociales_renueva {
  derived_table: {
    sql: Select
              D.Comercio,
              D.Fecha,
            ...
            From
              dbo.Consolidadov6
        Where NombreMedidas Like '%Renueva%'
            Union All
            ...
            Where
              A.fecha Between '2023-09-01' And  '2023-12-31' And A.idPrograma In ('219') And C.Comercio Is Null
            ) D
