...
view: programas_sociales_hipoteca_verde {
  derived_table: {
    sql: Select
              D.Comercio,
              D.Fecha,
            ...
            From
              dbo.Consolidadov6
        Where NombreMedidas Like '%Hipoteca%'
            Union All
            ...
            Where
              A.fecha Between '2023-09-01' And  '2023-10-31' And A.idPrograma In ('10') And C.Comercio Is Null
            ) D
